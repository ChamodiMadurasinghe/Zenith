...
**Full guide:** [Vector_Pattern_Engine.md](../docs/Vector_Pattern_Engine.md) and shareable [Zenith-Vector-Pattern-Engine-Reference.docx](../docs/Zenith-Vector-Pattern-Engine-Reference.docx) (regenerate with `python scripts/generate_vector_docs_docx.py`). Architecture diagrams: [docs/diagrams/vector/](../docs/diagrams/vector/).
