...
INSERT INTO user_bank_account (user_id, account_name, nickname, available_balance, overdraft_limit, ceiling_lkr, branch_name, bank_name) VALUES
    (1, 'Yohan Hardware Pvt Ltd', 'Main Hardware Checking', 2500000.00, 500000.00, 500000.00, 'Pettah Branch',       'Commercial Bank of Ceylon'),
    (1, 'Yohan Hardware Pvt Ltd', 'Reserve Account',        850000.00,  0.00,      250000.00, 'Colombo Fort Branch', 'Hatton National Bank');
